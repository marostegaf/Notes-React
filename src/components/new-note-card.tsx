...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="flex flex-col rounded-md bg-neutral-700 text-left p-5 gap-3 hover:ring-2 hover:ring-lime-400">
                    ...
                    <form className="flex-1 flex flex-col">
                        <div className="flex flex-1 flex-col gap-3 p-5">
                            ...
                            {shouldShowOnBoarding ? (
                                ...
                                <textarea
                                    autoFocus
                                    className="text-sm leading-6 text-neutral-50 bg-transparent resize-none flex-1 outline-none"
                        ...
                        {isRecording ? (
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 bg-neutral-700 py-4 text-center text-sm text-neutral-50 outline-none font-medium hover:text-neutral-50"
                            >
